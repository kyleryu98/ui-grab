...
export const VERSION = getRuntimeEnv("VERSION") ?? "[DEV]";
...
export const FROZEN_ELEMENT_ATTRIBUTE = "data-ui-grab-frozen";

export const USER_IGNORE_ATTRIBUTE = "data-ui-grab-ignore";
...
export const TOOLBAR_MIN_RESIZABLE_WIDTH_PX = 44;
export const TOOLBAR_MAX_RESIZABLE_WIDTH_PX = 240;
export const TOOLBAR_MIN_RESIZABLE_HEIGHT_PX = 44;
export const TOOLBAR_MAX_RESIZABLE_HEIGHT_PX = 240;
export const TOOLBAR_DEFAULT_SCALE = 1;
export const TOOLBAR_MIN_SCALE = 0.9;
export const TOOLBAR_MAX_SCALE = 1.8;
