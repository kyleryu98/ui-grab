...
const UI_GRAB_MIME_TYPE = "application/x-ui-grab";

export interface UiGrabEntry {
  tagName?: string;
...
export const copyContent = (
  ...
  const uiGrabMetadata: UiGrabMetadata = {
    version: VERSION,
    content,
    entries,
    timestamp: Date.now(),
