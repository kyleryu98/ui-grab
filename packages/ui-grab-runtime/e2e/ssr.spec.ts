...
test.describe("SSR Compatibility", () => {
  test("importing ui-grab in Node.js should not throw", () => {
  ...
  test("importing ui-grab/core in Node.js should not throw", () => {
    const result = execSync(
  ...
  test("ESM import of ui-grab in Node.js should not throw", () => {
