...
test.describe("Disabled Element Selection", () => {
  test.beforeEach(async ({ uiGrab }) => {
    await uiGrab.page.evaluate((containerId) => {
  ...
  test("should select disabled button element", async ({ uiGrab }) => {
    await uiGrab.activate();

    const bounds = await uiGrab.getElementBounds(
  ...
  test("should select disabled input element", async ({ uiGrab }) => {
    await uiGrab.activate();
  ...
  test("should select disabled textarea element", async ({ uiGrab }) => {
    await uiGrab.activate();
  ...
  test("should select disabled select element", async ({ uiGrab }) => {
    await uiGrab.activate();
  ...
  test("should include disabled elements in drag selection", async ({
    ...
    const containerBounds = await uiGrab.getElementBounds(
...
test.describe("Pointer Events None - Arrow Navigation", () => {
  ...
  test("should support round-trip navigation", async ({ uiGrab }) => {
    await uiGrab.page.evaluate((containerId) => {
      const container = document.getElementById(containerId);
      const parent = document.createElement("div");
